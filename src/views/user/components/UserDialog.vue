  ...
  >
    <el-form ref="form" label-position="right" label-width="90px" :model="form" :rules="rules">
      <el-form-item label="用户名" prop="username">
        <el-input v-model="form.username" :placeholder="nicknamePlaceholder" />
      </el-form-item>
      <el-form-item label="昵称" prop="nickname">
        <el-input v-model="form.nickname" :placeholder="usernamePlaceholder" />
      </el-form-item>
      ...
      <el-form-item label="企业微信Id" prop="workWechatId">
        <el-input v-model="form.workWechatId" placeholder="请输入企业微信Id" />
      </el-form-item>
    </el-form>
